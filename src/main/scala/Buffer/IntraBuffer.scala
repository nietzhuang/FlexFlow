...
class IntraBank(bitwidth: Int, depth: Int) extends Module {
...
class IntraBuffer(bitwidth: Int, depth: Int, numBank: Int) extends Module {
  ...
  val bank0   = Module(new IntraBank(bitwidth, depth))
  val bank1   = Module(new IntraBank(bitwidth, depth))
  val bank2   = Module(new IntraBank(bitwidth, depth))
  val bank3   = Module(new IntraBank(bitwidth, depth))
  val bank4   = Module(new IntraBank(bitwidth, depth))
  val bank5   = Module(new IntraBank(bitwidth, depth))
  val bank6   = Module(new IntraBank(bitwidth, depth))
  val bank7   = Module(new IntraBank(bitwidth, depth))
  val bank8   = Module(new IntraBank(bitwidth, depth))
  val bank9   = Module(new IntraBank(bitwidth, depth))
  val bank10  = Module(new IntraBank(bitwidth, depth))
  val bank11  = Module(new IntraBank(bitwidth, depth))
  val bank12  = Module(new IntraBank(bitwidth, depth))
  val bank13  = Module(new IntraBank(bitwidth, depth))
  val bank14  = Module(new IntraBank(bitwidth, depth))
  val bank15  = Module(new IntraBank(bitwidth, depth))
...
object IntraBuffer extends App {
  (new chisel3.stage.ChiselStage).emitVerilog(new IntraBuffer(16, 1024, 16))
}
